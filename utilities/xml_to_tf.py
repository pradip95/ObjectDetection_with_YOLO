...
data_dir = '../data\\'
Dataset_names_path = "../data/Dataset_names.txt"
Dataset_train = "data/labels/Dataset_train_labels.txt"
Dataset_test = "data/labels/Dataset_test_labels.txt"
is_subfolder = False
